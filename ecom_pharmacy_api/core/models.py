...
class Person(AbstractUser):
    ...
    profile_picture = VersatileImageField(upload_to='profiles/', blank=True, null=True)
    slug = AutoSlugField(populate_from='username', unique=True, always_update=False, null=True, blank=True)
